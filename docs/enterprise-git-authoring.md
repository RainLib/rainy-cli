...
jobs:
  validate:
    ...
    steps:
      ...
      - name: Install Rainy
        run: curl -fsSL https://github.com/RainLib/rainy-cli/releases/download/v0.5.5/install.sh | RAINY_VERSION=v0.5.5 sh
      - name: Validate packs
        run: |
...
validate-rainy-registry:
  ...
  before_script:
    ...
    - curl -fsSL https://github.com/RainLib/rainy-cli/releases/download/v0.5.5/install.sh | RAINY_VERSION=v0.5.5 sh
  script:
